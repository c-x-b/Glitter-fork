...
public:
    ...
    // ------------------------------------------------------------------------
    Shader(const char* vertexPath, const char* fragmentPath, const char* headerPath = nullptr)
    {
        ...
        try 
        {
            ...
            if (headerPath != nullptr) {
                vertexSrc = headerSrc + vShaderStream.str();
                fragmentSrc = headerSrc + fShaderStream.str();
            }	
            else {
